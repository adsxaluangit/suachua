...
export interface ApiRepairRequestRepairRequest
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::repair-request.repair-request'
    > &
      Schema.Attribute.Private;
    priority: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Trung b\u00ECnh'>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    status: Schema.Attribute.String & Schema.Attribute.DefaultTo<'M\u1EDBi'>;
    submittedDate: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_role: Schema.Attribute.String & Schema.Attribute.DefaultTo<'USER'>;
    username: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::repair-request.repair-request': ApiRepairRequestRepairRequest;
